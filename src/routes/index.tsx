...
import { Search, ExternalLink, Heart, Moon, Sun, RefreshCw, Loader2 } from "lucide-react";
...
const CATALOGS = [
  ...
  { id: "wu769809876", name: "WU Collection", url: "https://wu769809876.x.yupoo.com/categories", category: "ropa" },
        ...
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6">
          <div className="flex flex-wrap gap-2">
            <button
              ...
              className={"rounded-sm border px-4 py-2 text-xs font-bold uppercase tracking-wider transition " + (cat === "all" && !showFavs ? "border-primary bg-primary text-primary-foreground" : "border-border bg-card hover:border-primary/50")}
            >
            ...
            {CATEGORIES.map((c) => (
              <button
                ...
                className={"rounded-sm border px-4 py-2 text-xs font-bold uppercase tracking-wider transition " + (cat === c.id && !showFavs ? "border-primary bg-primary text-primary-foreground" : "border-border bg-card hover:border-primary/50")}
              >
            ...
            <button
              ...
              className={"ml-auto flex items-center gap-1.5 rounded-sm border px-4 py-2 text-xs font-bold uppercase tracking-wider transition " + (showFavs ? "border-primary bg-primary text-primary-foreground" : "border-border bg-card hover:border-primary/50")}
            >
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 sm:gap-4 lg:grid-cols-4">
            {filtered.map((p) => (
              ...
              >
                ...
                >
                  <Heart className={"h-3.5 w-3.5 " + (favs.includes(p.id) ? "fill-primary text-primary" : "text-foreground")} />
                </button>
